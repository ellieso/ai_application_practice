...
from pptx.util import Inches    # 사진, 표 작성
prs = Presentation()
...
###### title+content ###############################################################
bullet_slide_layout = prs.slide_layouts[1]          # 제목과 bullet으로 내용을 입력하는 레이아웃 선택
...
##### add picture ##################################################################
img_path = 'camera.jpeg'                     # 원본 사진이 저장된 경로
...
# 표 항목의 제목 작성
table.cell(0,0).text = '회사명'
table.cell(0,1).text = '주식가격'
# 쎌 내용 작성
